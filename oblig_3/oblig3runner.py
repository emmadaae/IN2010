...
import insertion
import quick
import bubble #importerer bubble og heap sort-filer
import heap
import math
import time
...
ALGS1 = [heap.sort]#, bubble.sort]
# Put the sorting algorithms under test for part 2 here
ALGS2 = [heap.sort]#, bubble.sort]
...
def run_algs_part1(A, infilename):
    for alg in ALGS1:
        ...
        outstr = '\n'.join(map(str, alg(countA))) #gjør om til str i map
